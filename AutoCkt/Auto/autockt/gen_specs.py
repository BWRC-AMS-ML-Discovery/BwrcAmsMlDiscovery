...
def gen_data(CIR_YAML, env, num_specs):
    ...
    for key, value in specs_range.items():
        ...
        i += 1
    with open("tmp/ckt_da_new/out/ngspice_specs_gen_" + env, "wb") as f:
...
def main():
    ...
    CIR_YAML = "/home/wayne/wayne/BwrcAmsMlDiscovery/AutoCkt/Ckt/eval_engines/ngspice/yaml_files/two_stage_opamp.yaml"
