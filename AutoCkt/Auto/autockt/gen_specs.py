...
def gen_data(CIR_YAML, env, num_specs):
    ...
    for key, value in specs_range.items():
        ...
        i += 1
    with open("AutoCkt/Auto/autockt/gen_specs/ngspice_specs_gen_" + env, "wb") as f:
...
def main():
    ...
    CIR_YAML = "AutoCkt/Ckt/eval_engines/ngspice/ngspice_inputs/yaml_files/two_stage_opamp.yaml"
